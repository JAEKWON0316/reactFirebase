...
const JoinB = () => {
  ...
  //encode Base64
  const encodeFileToBase64 = (fileB) => {  //file을 binary타입으로 바꿔서 보재누는 Base64
        ...
        <div className="col-md-6 col-lg-5">
          <div className="shadow-lg p-3 mb-5 bg-white roundbox">
            <div className="login-wrap icon">
              <span>
                {
                  fileName ? <img src={userIcon} alt={fileName} className='userIcon' /> 
                  : 
                   <FaUserLarge />
                }        
              </span>
              <h1 className='mt-3'>회원가입 2단계</h1>
